# VybeMatch -- Help Center FAQ

*Exhaustive FAQ / knowledge base for the VybeMatch web app and iOS/Android apps. Generated 2026-09-22 from the same content that powers the in-app Help Center (`/help`) and the VybeHelp 💬 chat agent, so this document and the app are always in sync.*

**76 questions across 13 topics.**

## Contents

- [👋 Getting started](#getting-started) (5 questions)
- [🔑 Account & signing in](#account-signing-in) (6 questions)
- [🧑 Your profile](#your-profile) (7 questions)
- [💫 Vybes: Just Vibing, Something Real, Rishta Ready](#vybes-just-vibing-something-real-rishta-ready) (6 questions)
- [🌀 Discover & matching](#discover-matching) (8 questions)
- [💬 Chatting after a match](#chatting-after-a-match) (10 questions)
- [🛡️ Safety, blocking & reporting](#safety-blocking-reporting) (7 questions)
- [📍 Privacy & location](#privacy-location) (5 questions)
- [✅ Verification](#verification) (3 questions)
- [📱 iOS & Android app](#ios-android-app) (7 questions)
- [⚙️ Managing your account](#managing-your-account) (4 questions)
- [🔧 Troubleshooting](#troubleshooting) (6 questions)
- [🙋 Still stuck?](#still-stuck) (2 questions)
...
### Which cities is VybeMatch available in?
...
### What is the minimum age to use VybeMatch?
...
### How is VybeMatch different from other dating apps?
...
### Can I change the phone number or email linked to my account?
...
### Can I be logged in on more than one device at once?

Yes -- log in on your phone and your laptop's browser at the same time if you like; both stay in sync with the same account.
...
### What do I need to fill out when setting up my profile?
...
### Can I edit my profile after I finish onboarding?
...
### How many photos can I add, and which one is shown first?
...
### What is a "tribe," and how is it different from interests?
...
### What does the verification status on my profile mean?
...
## 💫 Vybes: Just Vibing, Something Real, Rishta Ready

### What's the difference between Just Vibing, Something Real, and Rishta Ready?
...
### Can I switch my Vybe (intent) after setting it?
...
### If I switch my intent, does it affect my existing matches and chats?

No -- switching your Vybe only changes what's shown on your profile going forward and what you'll see in Discover next. It doesn't unmatch anyone or touch your existing conversations.

### What is the Vybe Check?
...
### What is the "family preview link" for Rishta Ready?
...
### I'm not sure if I want Something Real or Rishta Ready -- which should I pick?
...
### How does the Discover feed decide who I see?
...
### How do I know why I matched with someone?
...
### What does the distance (like "6 km away") next to a profile mean?
...
### I've run out of new profiles in Discover -- now what?
...
There's currently no way to undo or take back a swipe once it's made -- take a moment before you decide.
...
Yes -- a match only happens when you and the other person have both swiped to express interest. If only one side has, nothing is shared and no conversation opens yet.

### I accidentally unmatched someone -- can we match again?
...
### What can I do right after matching with someone?
...
### Can I reply to a specific message or like one?
...
Tap the emoji icon next to the message box to open a picker with a full set of emoji to choose from.

### Can I mute a conversation without unmatching or blocking?
...
### What's the difference between deleting a conversation and unmatching?
...
### Does VybeMatch have video calling?

Not currently -- video calling isn't available as a chat option right now. Plans and in-app messaging are the way to coordinate meeting up.
...
### What's the "how did it go" prompt about after meeting up?
...
### What's in the Match Profile panel inside a chat?
...
### What's the difference between blocking, reporting, and unmatching?
...
Open the "..." menu in your conversation with them and choose "Unmatch." This is final and cannot be undone from either side.

### What safety tips does VybeMatch give before meeting someone in person?
...
### Someone sent me an uncomfortable or inappropriate message -- what should I do?
...
Report it with the "Fake profile" reason from the "..." chat menu, and consider blocking to stop further contact while the report is reviewed.

---

## 📍 Privacy & location

### How does location sharing work, and is it required?
...
### Can anyone see my exact location?

No -- only a rounded distance (like "3 km away" or "Nearby") is ever shown to anyone else. Your exact coordinates are never exposed, even to your matches.

### Why does someone's distance show with a "~" in front of it?
...
### What happens to my data if I stop sharing location?

Turning location off clears your stored coordinates -- nothing is retained for distance calculations once you've turned it off.

### Who can see my family preview link if I turn it on?

Anyone you send the link to -- it is not searchable or discoverable on its own, and it only exists while the toggle is on. Turning it off in Profile disables the link immediately, even for people who already have it.
...
A verified badge signals to potential matches that you're a real, confirmed person -- it tends to build more trust and can improve how much attention your profile gets. It's optional, but recommended.

### My verification failed -- can I try again?

Yes -- go back to Profile → Trust layer and start verification again. Make sure you are in good lighting and your ID document is clearly visible and not expired.

---

## 📱 iOS & Android app

### Where do I download the VybeMatch app?

The iOS app is available on the App Store and the Android app on the Play Store -- search "VybeMatch." The mobile app uses the exact same account and data as the website, so there's nothing separate to set up.

### The app is asking for location permission -- do I have to allow it?
...
### Do I need to update the app to get new features?
...
### The app seems frozen or unresponsive -- what should I try?
...
### A screen isn't scrolling -- is something broken?
...
### Does the mobile app have all the same features as the website?

Yes -- the iOS and Android apps and the website all run the same VybeMatch experience with the same features. The mobile apps additionally offer real device integrations like location sharing through your phone's own permission system.

### If I uninstall and reinstall the app, will I lose anything?

No -- your profile, matches, and chats live on VybeMatch's servers under your account, not on your device. Reinstalling and logging back in brings everything back exactly as it was.
...
There isn't a self-serve delete option in the app yet -- reach out from the Contact section below and the team will take care of it for you.

### What's the difference between pausing with Quiet Mode and deleting my account?
...
Reach out from the Contact section below with your request, and the team will help.

### Can I have more than one profile?

Each account is meant to represent one real person with one profile -- creating multiple profiles isn't supported and may get flagged as a fake profile if reported.

---

## 🔧 Troubleshooting

### I matched with someone but can't find the conversation -- where did it go?
...
### My photo won't upload -- what's wrong?
...
### A message isn't sending -- what should I check?

Check your internet connection first. If it's stable and the message still won't send, force-close and reopen the app -- it usually resolves on the next attempt.

### I'm seeing people from the wrong city, or nobody from mine -- why?
...
### The "Make a plan" wizard seems stuck on a step -- what do I do?

Try tapping your selection again, or use the back option in the wizard to re-select the previous step. If it is still stuck after that, force-close and reopen the app and start the plan again.

### I think I've found a bug that's not covered here -- what should I do?

Please report it from the Contact section below with as much detail as you can: what screen you were on, what you tapped, and what happened instead of what you expected. Screenshots help a lot.

---

## 🙋 Still stuck?

### VybeHelp and this Help Center did not answer my question -- what now?
...
### I'm in an unsafe situation right now -- what should I do?
...
Open the **VybeHelp 💬** bubble anywhere in the app (web, iOS, or Android) and ask your question in plain language -- it searches this exact Help Center to answer you. You can also browse and search this content directly in-app at **Profile → Help & Support**.
